...
<body>
    ...
    include "conexao.php";
    $sql = "SELECT publicacaoagente.id,bairro.nomeBairro, rua.nome, publicacaoagente.nivel, publicacaoagente.publicacao from bairro,rua,publicacaoagente  where bairro.id = publicacaoagente.id_bairro and rua.id = publicacaoagente.id_rua and bairro.nomeBairro like '%$pequisa%' order by publicacaoagente.id desc";
            ...
            <div class="col">
                <nav class="navbar navbar-light bg-light col-6">
                    <div class="container-fluid ">
                        ...
                        <form class="d-flex" action="pesquisarOcorrencia.php" method="POST">
